...
export const metadata: Metadata = {
  title: "JPG to PDF — Convert JPEG Images to PDF Free | No Upload",
  ...
  openGraph: { title: "JPG to PDF — Free JPEG to PDF Converter | No Upload", description: "Convert JPEG images to PDF privately in your browser." },
};
