...
export default function PngToPdfPage() {
  return (
    <main className="content-page">
      ...
      <p>PNG images often contain transparent backgrounds. LocalPDF automatically renders transparent areas as white in the output PDF for reliable viewing across all PDF readers. The Balanced quality preset ensures good text readability for screenshots while keeping file sizes manageable.</p>
      <h2>When to Use PNG vs JPEG for PDF</h2>
      <p>PNG is ideal for screenshots, diagrams, logos, and images with text — anything with sharp edges or transparency. JPEG is better for photos. LocalPDF handles both formats and optimizes the output accordingly.</p>
